...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 1. 锁定新登录页行为验收基线（测试辅助函数与登录页 E2E 基线） | **A** | **R** | **C** | **I** | `[x]` |
| 2. 制作并验证 4K 品牌视觉资产（品牌标识与 3D 主视觉） | **A** | **R** | **C** | **I** | `[x]` |
| 3. 重构认证画布与左侧品牌区域（双栏布局、工具栏、左侧主视觉） | **A** | **R** | **C** | **I** | `[x]` |
| 4. 重构登录卡并保留认证行为（字段、记住账号、第三方入口、文案） | **A** | **R** | **C** | **I** | `[x]` |
| 5. 最终视觉与功能验证（叠图、E2E、构建、design-qa 结论） | **A** | **C** | **R** | **I** | `[x]` |
