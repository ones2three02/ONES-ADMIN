...
- HRMS 当前已形成员工主数据、任职记录/岗位历史、生命周期、合同、合同附件前端上传/查看/移除与下载授权、花名册导入导出、人力概览、员工档案抽屉和 Vben 页面基础闭环，后续需要继续补在线预览能力、更深入的 HRMS 报表分析和员工档案薪酬、绩效等更多业务分栏。
