...
- 后端：Spring Boot 3.5.9、Sa-Token 1.45.0、MyBatis-Plus 3.5.16、Flyway、MySQL、Redis、RabbitMQ、MinIO、统一响应、统一异常、登录认证、角色权限、动态菜单、用户 CRUD、接口资源治理、接口生命周期治理、接口治理修复建议、Actuator、Swagger UI。
