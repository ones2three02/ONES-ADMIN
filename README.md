...
- 前端基座：Vue3、Vite、TypeScript、Vben / Ant Design Vue、Pinia、Vue Router、Axios 请求拦截、错误提示 TraceId 展示、登录页 ONES/1S 品牌资源、管理布局、工作台、系统管理页、HRMS 一期页面、接口治理页、审计页、文件管理页、前端布局治理报告和引导式交互规范。
...
- 前端表格稳定高度仍在持续治理中；员工、合同和系统用户等复杂分栏页已治理，接口资源、审计、文件、字典、岗位、职级、资料预警、花名册导入等页面仍需后续版本收敛。
