...
- 前端：Vue3、Vite、TypeScript、Vben / Ant Design Vue 组件体系、Pinia、Vue Router、Axios 请求拦截、错误提示 TraceId 展示、Vben 风格企业级安全登录页、ONES/1S 核心视觉与白天/夜间品牌资源、飞书优先的紧凑企业登录入口、管理布局、工作台、用户管理页、接口管理页、审计日志页、接口调用方筛选与展示、Manifest 基线快照、发布门禁、发布就绪、负责人待办和治理规则视图、HRMS 人力概览页、HRMS 员工列表导出入口、HRMS 花名册导入页、Playwright 登录冒烟用例。
